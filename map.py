...
def load_data():
    ...
    df_facility = pd.read_excel('C:/Users/minja/Desktop/capstone_web (1)/capstone_web/data/흡연구역전체통합본.xlsx')
    ...
    with open('C:/Users/minja/Desktop/capstone_web (1)/capstone_web/data/seoul_municipalities_geo_simple.json', 'r', encoding='utf-8') as f:
